...
document.getElementById('sendChatMessage').addEventListener('click', async () => {
    ...
    try {
        const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
            method: "POST",
            headers: {
                "Authorization": "Bearer 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",
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { role: "system", content: "You are an Aadhaar Assistant. Keep answers short and Aadhaar relevant." },
        ...
        appendMessage('ai', reply); //This shows in how many words will ai reply
    } catch (err) {
        console.error(err);
